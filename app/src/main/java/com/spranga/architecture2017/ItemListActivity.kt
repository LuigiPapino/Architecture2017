...
import com.spranga.architecture2017.dummy.DummyContent
...
class ItemListActivity : AppCompatActivity() {
  ...
  inner class SimpleItemRecyclerViewAdapter(
      private val mValues: List<DummyContent.DummyItem>) : RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder>() {
