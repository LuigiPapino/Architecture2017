...
class HttpsConnectionWrapper extends HttpsURLConnection {
  ...
  HttpsConnectionWrapper(HttpsURLConnection wrappedConnection) {
    super(null);
  ...
  public void setHostnameVerifier(HostnameVerifier v) {
    this.mWrappedConnection.setHostnameVerifier(v);
  }
  ...
  public void setSSLSocketFactory(SSLSocketFactory sf) {
    this.mWrappedConnection.setSSLSocketFactory(sf);
  }
